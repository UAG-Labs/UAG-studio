...
2.1 Goals
   ...
   2.1.E Define diagnostics state.
...
3.1 Functional requirements
   3.1.A State tracks file path, dirty state, graph, view, selection, diagnostics, compile result.
...
4.1 Type-specific detail
   4.1.A Data includes project metadata, graph objects, layout, selection, diagnostics, export status.
